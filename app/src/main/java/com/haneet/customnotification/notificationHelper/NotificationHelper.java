package com.haneet.customnotification.notificationHelper;
...
import com.haneet.customnotification.Constants;
import com.haneet.customnotification.R;
import com.haneet.customnotification.notficationBuilder.GetCustomLayBuilder;
import com.haneet.customnotification.notficationBuilder.GetSimpleBuilder;
import com.haneet.customnotification.notficationBuilder.GetStyledBuilder;
    ...
    public NotificationCompat.Builder getBuilder(int notificationType){
        ...
        switch (notificationType){
            ...
            case Constants.GET_CUSTOM_LAY_NOTIFICATION:
                mBuilder = GetCustomLayBuilder.createNotification(context);
                break;
        }
